...
class Menu extends Model
{
    ...
    public function updateMenu($request){
        try{
            DB::beginTransaction();
            Menu::where('id', $request->po_menu_id)->update(['name' => $request->menu_name, 'link' => $request->link]);
