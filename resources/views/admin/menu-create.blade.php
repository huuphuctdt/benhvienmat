            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            <input type="text" class="form-control" id="menu_name_1" name="menu_child_name[]" placeholder="Enter menu child name..." value="{{ old('menu_child_name')[5] }}">
                        </div>
                        <div class="col-md-12 form-group">
                            <input type="text" class="form-control" id="menu_name_2" name="menu_child_name[]" placeholder="Enter menu child name..." value="{{ old('menu_child_name')[6] }}">
                        </div>
                        <div class="col-md-12 form-group">
                            <input type="text" class="form-control" id="menu_name_3" name="menu_child_name[]" placeholder="Enter menu child name..." value="{{ old('menu_child_name')[7] }}">
                        </div>
                        <div class="col-md-12 form-group">
                            <input type="text" class="form-control" id="menu_name_4" name="menu_child_name[]" placeholder="Enter menu child name..." value="{{ old('menu_child_name')[8] }}">
                        </div>
                        <div class="col-md-12 form-group">
                            <input type="text" class="form-control" id="menu_name_5" name="menu_child_name[]" placeholder="Enter menu child name..." value="{{ old('menu_child_name')[9] }}">
                        </div>
                    </div>
                </div>
            </div>
