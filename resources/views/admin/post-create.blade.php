    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-4 m-t-20 text-right">
                <a class="btn btn-warning" href="{{ url('admin/post') }}">Quay về</a>
            </div>
        </div>
        <hr>
        ...
        <form class="form-group" action="{{ url('admin/post/create_post') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-md-5 {{ $errors->has('name') ? ' has-error' : '' }}">
                        <textarea class="form-control" id="name" name="name" placeholder="Enter name..."  rows="1">{{ old('name') }}</textarea>
                        @if ($errors->has('name'))
                            <span class="help-block">
            ...
            <div class="row col-md-offset-2 m-t-20 {{ $errors->has('content') ? ' has-error' : '' }}">
                ...
                <textarea name="content" class="form-control my-textarea"></textarea>
