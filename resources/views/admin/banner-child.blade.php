...
@section('admin-content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Banner Nhỏ</h1>
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i> Banner Nhỏ
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="col-lg-12">
        ...
        @endif
        <form class="form-horizontal" action="{{ url('admin/banner-child/update') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
