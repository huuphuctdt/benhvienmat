...
@section('admin-content')
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-8">
                <h2>Chi tiết ý kiến khách hàng</h2>
            </div>
        ...
        @endif
        <form class="form-group" action="{{ url('admin/review/edit') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-md-3 {{ $errors->has('content') ? ' has-error' : '' }}">
                        <textarea class="form-control" id="content" name="content" placeholder="Enter content...">{{ old('content', $review->content) }}</textarea>
                    ...
                    <div class="col-md-3 {{ $errors->has('image') ? ' has-error' : '' }}">
                        <img src="{{ url('images/'.$review->image) }}" width="200">
