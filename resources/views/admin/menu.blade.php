...
@section('admin-content')
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-4 m-t-20 col-md-offset-8">
                <a class="btn btn-success" href="menu/create">Tạo</a>
            </div>
        </div>
        <hr>
        ...
        @foreach($menus as $menu)
            <div class="row">
                ...
                <label class="control-label col-md-2" for="pwd">{{ "Menu" }}</label>
                ...
                <form class="form-horizontal" action="{{ url('admin/menu/update') }}" method="post">
                    ...
                    <div class="col-md-2">
                        ...
                        <a class="btn btn-primary" href="{{ url('admin/menu/'.$menu->id) }}">Chi tiết</a>
                        <button onclick="return confirm('Bạn có chắc chắn muốn xoá không? \nNếu xoá sẽ mất tất cả các menu con!');" type="submit" class="btn btn-danger">Xóa</button>
                    </div>
                </form>
                {{--<div class="col-md-2">--}}
