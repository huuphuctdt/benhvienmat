    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-4 m-t-20">
                <a class="btn btn-success" href="{{ url('admin/post_category/create') }}">Tạo</a>
            </div>
        </div>
        <hr>
                ...
                <div class="form-group">
                    ...
                    <form class="form-horizontal" action="{{ url('admin/post_category/delete') }}" method="post">
                        ...
                        <div class="col-md-2">
                            ...
                            <a class="btn btn-primary" href="{{ url('admin/post_category/'.$postcategory->id) }}">Chi tiết</a>
                            @if($postcategory->id != 1)
                            <button onclick="return confirm('Bạn có chắc chắn muốn xoá không?\nNếu xóa danh mục này. \nCác bài viết thuộc danh mục sẽ chuyển sang danh mục đầu tiên.');" type="submit" class="btn btn-danger">Xóa</button>
                            @endif
                        </div>
                    </form>
                </div>
